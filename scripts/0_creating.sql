...
LOAD DATA LOCAL INFILE "C:/Users/User/Documents/hse/ma/second/sql-nosql/project/data/tracks.csv"  -- You need to change the path...
INTO TABLE tracks
...
LOAD DATA LOCAL INFILE 'C:/Users/User/Documents/hse/ma/second/sql-nosql/project/data/albums.csv'  -- You need to change the path...
INTO TABLE albums 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'C:/Users/User/Documents/hse/ma/second/sql-nosql/project/data/playlists.csv'  -- You need to change the path...
...
LOAD DATA LOCAL INFILE 'C:/Users/User/Documents/hse/ma/second/sql-nosql/project/data/track_characteristics.csv'  -- You need to change the path...
...
LOAD DATA LOCAL INFILE 'C:/Users/User/Documents/hse/ma/second/sql-nosql/project/data/track_to_album.csv'  -- You need to change the path...
...
LOAD DATA LOCAL INFILE 'C:/Users/User/Documents/hse/ma/second/sql-nosql/project/data/track_to_playlist.csv'  -- You need to change the path...
